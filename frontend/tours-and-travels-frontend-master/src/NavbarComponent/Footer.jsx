        ...
        <div className="footer-container">
          <div className="footer-grid">
            ...
            <div className="footer-column">
              <h3 className="footer-heading">TripTastic</h3>
              <p className="footer-description">
                Discover extraordinary travel experiences across breathtaking destinations worldwide. Your adventure begins here.
              </p>
              <div className="footer-contact">
                <p>📧 support@triptastic.com</p>
                <p>📞 +1 (234) 567-8900</p>
              </div>
            </div>
        ...
        <div className="footer-container">
          <div className="footer-bottom-content">
            <p className="footer-copyright">
              © 2025 TripTastic. All rights reserved.
            </p>
