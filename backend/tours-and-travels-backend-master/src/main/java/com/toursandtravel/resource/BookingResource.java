...
//				|| request.getCardNo() == null) {
		if (request.getTourId() == null || request.getTourId().isEmpty() ||
				request.getCustomerId() == null || request.getCustomerId().isEmpty() ||
				request.getNoOfTickets() == 0 ||
				request.getCvv() == null || request.getExpiryDate() == null ||
				request.getNameOnCard() == null || request.getCardNo() == null) {
	...
	public ResponseEntity<BookingResponseDto> fetchAllBookingsByTour(String tourId) {
	...
	public ResponseEntity<BookingResponseDto> fetchAllBookingsByCustomer(Integer customerId) {
		...
		User customer = this.userService.getUserById(String.valueOf(customerId));
	...
	public ResponseEntity<BookingResponseDto> fetchAllBookingsByTourGuideId(Integer tourGuideId) {
		...
		User tourGuide = this.userService.getUserById(String.valueOf(tourGuideId));
