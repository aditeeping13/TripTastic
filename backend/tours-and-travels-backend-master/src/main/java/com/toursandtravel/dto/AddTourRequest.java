...
//				|| request.getTransportId() == null || request.getVehicleRegistrationNo() == null
...
//				"lodgingId", "image1", "image2", "image3", "activities", "meals");
//		return tour;
//	}
//
//}
...
public class AddTourRequest {
	...
	public static Tour toTourEntity(AddTourRequest request) {
		Tour tour = new Tour();
		BeanUtils.copyProperties(request, tour, "id", "guideId", "fromLocationId", "toLocationId",
				"transportId", "lodgingId", "image1", "image2", "image3", "activities", "meals");
		return tour;
	}
}
