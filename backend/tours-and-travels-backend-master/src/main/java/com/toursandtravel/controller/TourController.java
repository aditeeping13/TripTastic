...
public class TourController {
	...
	public ResponseEntity<CommonApiResponse> deleteTour(@RequestParam("tourId") String tourId) {
	...
	public ResponseEntity<TourResponseDto> fetchActiveToursByLocation(
			@RequestParam("fromLocationId") String fromLocationId,
			@RequestParam("toLocationId") String toLocationId) {
	...
	public ResponseEntity<TourResponseDto> getAllToursByTourGuide(@RequestParam("tourGuideId") String tourGuideId) {
		return this.tourResource.getAllToursByTourGuide(tourGuideId);
	}

	@GetMapping("fetch")
	public ResponseEntity<TourResponseDto> fetchTourByTourId(@RequestParam("tourId") String tourId) {
