...
public class UserController {
	...
	public ResponseEntity<CommonApiResponse> deleteGuide(@RequestParam("guideId") String guideId) {
		return userResource.deleteGuide(guideId);
	}

	@GetMapping("/fetch/user-id")
	@Operation(summary = "Api to get User Detail By User Id")
	public ResponseEntity<UserResponseDto> fetchUserById(@RequestParam("userId") String userId) {
